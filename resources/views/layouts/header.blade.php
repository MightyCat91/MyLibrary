...
<script src="{{ Request::root()}}/js/jquery-1.11.1.min.js"></script>
      ...
      {{--<div class="container-fluid">--}}
        {{--<div class="navbar-header">--}}
          {{--<button type="button" class="navbar-toggle collapsed" data-toggle="collapse" data-target="#navbar" aria-expanded="false" aria-controls="navbar">--}}
            ...
            {{--<span class="icon-bar"></span>--}}
          {{--</button>--}}
          {{--<a class="navbar-brand" href="index.html"><h1><img src="{{ Request::root()}}/images/logo (2).png" alt="" /></h1></a>--}}
        {{--</div>--}}
        {{--<div id="navbar" class="navbar-collapse collapse">--}}
            ...
            {{--<div class="header-top-right">--}}
                ...
                {{--<div class="signin">--}}
                    ...
                    {{--<!-- pop-up-box -->--}}
                                    {{--<script type="text/javascript" src="{{ Request::root()}}/js/modernizr.custom.min.js"></script>--}}
                                    {{--<link href="{{ Request::root()}}/css/popuo-box.css" rel="stylesheet" type="text/css" media="all" />--}}
                                    {{--<script src="{{ Request::root()}}/js/jquery.magnific-popup.js" type="text/javascript"></script>--}}
                                    {{--<!--//pop-up-box -->--}}
