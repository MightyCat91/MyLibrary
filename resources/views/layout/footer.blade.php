    ...
    <div class="container">
        <div class="row">
            <div class="3u">
                <section>
                    <ul class="style1">
                        <li><img src="{{asset('images/pics05.jpg')}}" width="78" height="78" alt="">

                            <p>Nullam non wisi a sem eleifend. Donec mattis libero eget urna. </p>

                            <p class="posted">August 11, 2014 | (10 ) Comments</p>
                        </li>
                        <li><img src="{{asset('images/pics06.jpg')}}" width="78" height="78" alt="">

                            <p>Nullam non wisi a sem eleifend. Donec mattis libero eget urna. </p>

                            <p class="posted">August 11, 2014 | (10 ) Comments</p>
                        </li>
                        <li><img src="{{asset('images/pics07.jpg')}}" width="78" height="78" alt="">
            ...
            <div class="3u">
                <section>
                    <ul class="style1">
                        ...
                        <li><img src="{{asset('images/pics10.jpg')}}" width="78" height="78" alt="">
            ...
            <div class="6u">
                <section>
                    ...
                    <p>In posuere eleifend odio. Quisque semper augue mattis wisi. Maecenas ligula. Pellentesque viverra
                        vulputate enim. Aliquam erat volutpat. Pellentesque tristique ante ut risus. Quisque dictum.
                        Integer nisl risus, sagittis convallis, rutrum id, elementum congue, nibh. Suspendisse dictum
                        porta lectus.</p>
                    <ul class="default">
